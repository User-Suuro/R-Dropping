...
Public Class EmployeePage
    ...
    Private Async Sub FetchEmployeesData()
        ...
        Await DialogTypes.ShowLoadingUntilAsync(
            ...
            Form1.Instance,
            Async Function()
                Dim sql As String = $"SELECT {Employee.id}, {Employee.first_name}, {Employee.middle_name}, {Employee.last_name}, {Employee.position}, {Employee.email} FROM {Employee.table_name}"
